...
$GLOBALS['TL_LANG']['tl_modal_gallery']['comparison_first_percentage']       = array('First Slide Percentage', 'Enter the percentage the first slide will take up of the slider when it loads. Remaining percentage will be divided up evenly amongst the other slides. Leave at 0 to split every slide evenly. Default is 50.');
